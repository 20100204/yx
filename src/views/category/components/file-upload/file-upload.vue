...
<template>
	<div style="height:80px;">
		...
		<Card>
			<div class="height-492px" style="height:100px;width:480px; " >
				<Col span="6">
				<Card>
					<Upload ref="upload" name='upload'
					:show-upload-list="false"
					 :default-file-list="defaultlist" :on-success="handleSuccess"
					 :on-error="handleError" :format="['jpg','jpeg','png']"
					 :max-size="400" :on-format-error="handleFormatError"
					...
					<Modal title="查看图片" v-model="visible" :z-index="8888888899999000">
						<img :src="src" v-if="visible" style="width: 100%">
					</Modal>
				</Card>
				</Col>
				<Col span="10" class="padding-left-20"  v-if="uploadpics.url">
	...
	export default {
		...
		methods: {
			...
			handleMaxSize(file) {
				this.$Notice.warning({
					title: '超出文件大小限制',
					desc: '文件 ' + file.name + ' 太大，不能超过 400K'
				});
			},
