    ...
    export default {
            ...
            return {
                ...
                list:{
                    cols:[
                            ...
                            render:(h,p)=>{
                                return h('a',{
                                    ...
                                    on:{
                                        ...
                                        click:()=>{
                                            this.$router.push({
                                                path: '/couponmanager/couponcashedit/' + p.row.id
                            ...
                            render:(h,p)=>{
                                if(p.row.scope=='市公司'){
                                    return h('a',{
                                        on:{
                                            click:()=>{
                                                this.$http.get('couponcash/scope&id='+p.row.id).then((res)=>{
                        ...
                        {key:'discount_amount',title:'金额',width:100},
        ...
        methods: {
            ...
            handleSearch(){
                ...
                this.$http.post('couponcash/lists',this.search).then((res)=>{
            ...
            handleAdd(){
                //添加
                this.$router.push({name:'couponcashadd'});
            },
            changePage(page){
                //分页
            ...
            init() {
                this.$http.get('couponcash/lists').then(
                    (res) => {
