	...
	<div style="height:80px;">
		...
		<Card>
			<div class="height-492px" style="height:100px; " v-if="">
				...
				<Card>
					<Upload ref="upload"
					name='upload' :show-upload-list="false"
					 :default-file-list="defaultlist"
					 :on-success="handleSuccess"
					 :on-error="handleError" :format="['jpg','jpeg','png']" :max-size="400" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" :before-upload="handleBeforeUpload" type="drag" :action="url" style="display:
...
<script>
	export default {
		...
		data() {
			return {
				url: this.$store.state.ycypurl + "?r=item/uppic&yu=1",
				src: '',
				imgName: '',
				visible: false,
				uploadpics: {
